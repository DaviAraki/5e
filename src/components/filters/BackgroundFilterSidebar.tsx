  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <PillFilter title="Skill Proficiency" options={SKILL_OPTIONS} state={skill} onCycle={cycle("skill")} onClear={clear("skill")} defaultOpen />
        <PillFilter title="Ability Score" options={ABILITY_OPTIONS} state={ability} onCycle={cycle("ability")} onClear={clear("ability")} defaultOpen />
